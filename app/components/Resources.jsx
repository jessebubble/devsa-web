...
function ResourceIcon({ icon: Icon }) {
    return (
        <div className="dark:bg-white/7.5 flex h-7 w-7 items-center justify-center rounded-full backdrop-blur-[2px] transition duration-300 group-hover:bg-white/10 dark:group-hover:bg-centroBlue/10 ">
...
function Resource({ resource }) {
    ...
    return (
        <div
            ...
            className="dark:bg-white/2.5 group relative flex rounded-2xl bg-neutral-50 transition-shadow hover:shadow-md hover:shadow-neutral-950/5 dark:hover:shadow-black/5"
        >
            <ResourcePattern
                {...resource.pattern}
                mouseX={mouseX}
                mouseY={mouseY}
            />
            <div className="ring-neutral-950/7.5 absolute inset-0 rounded-2xl ring-1 ring-inset group-hover:ring-neutral-950/10 dark:ring-white/10 dark:group-hover:ring-white/20" />
...
export function Resources() {
    return (
        <div className="my-16 xl:max-w-none">
            <div className="not-prose mt-4 grid grid-cols-1 gap-8 border-t border-neutral-950/5 pt-10 sm:grid-cols-2 xl:grid-cols-4 dark:border-white/5">
