    ...
    return (
        <>
            <div className="mt-24 rounded-3xl bg-neutral-950 py-24 sm:mt-32 lg:mt-40 lg:py-32">
                ...
                >
                    <p>
                        We have various social channels, such as GitHub, Twitch,
                        and in-person meetups in place to showcase the diversity
                        of the creative and development community in San Antonio
                    </p>
                </SectionIntro>
