...
const BlogSection = () => {
    ...
    return (
        <>
            ...
            >
                <p>
                    The user doesn't care which tools you use, and neither do
                    we. We want to celebrate your work, learn from it, and grow
                    as a community. If you have a project you'd like to share or
                    a topic you'd like to discuss, we'd love to hear from you!
                </p>
            </SectionIntro>
            ...
            <Container className="mt-24 sm:mt-32 md:mt-40">
                <FadeIn className="max-w-3xl">
                    <h1 className="font-display text-balance text-5xl font-medium tracking-tight text-neutral-950 sm:text-7xl">
                        ...
                        <strong className="text-spursTurq">
                            so is our tech stack
                        </strong>
                    </h1>
                    <p className="mt-6 text-balance text-xl text-neutral-600">
                        The goal of devSA is to initiate conversations and
                        foster collaboration within the design, web development,
                        and engineering community in San Antonio, Texas
                    </p>
                </FadeIn>
            </Container>
