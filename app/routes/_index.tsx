        ...
        <>
            ...
            <Container className="mt-24 sm:mt-32 md:mt-56">
                ...
                <h1 className="font-display text-5xl font-medium tracking-tight text-neutral-950 [text-wrap:balance] sm:text-7xl">
                    Because we believe that <span className="text-centroPink">Tech in SA</span> is more than just gov contracts   
                </h1>
                <p className="mt-6 text-xl text-neutral-600">
                    Beyond the billion-dollar industry that powers Military City, USA
                    is a community of designers, marketing agencies and web developers in San Antonio creating online experiences on platforms that reach millions of people every day
                </p>
                </FadeIn>
            </Container>
